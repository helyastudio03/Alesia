      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <Card className="w-full max-w-md text-center">
          <CardContent className="pt-8 pb-8">
            ...
            <p className="text-gray-600 mb-4">Un lien de confirmation vous a été envoyé.</p>
            <Link href="/auth/login" className="text-violet-600 hover:underline text-sm">
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="text-2xl font-bold text-gray-900">Alesia</span>
        </div>

        <Card>
          <CardHeader className="text-center">
            <CardTitle>Créer un compte</CardTitle>
            <CardDescription>Rejoignez la plateforme IEF</CardDescription>
          </CardHeader>
